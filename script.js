...
const guestList = [
    ...
    "Sheryl Lou Apuhin", "Arsenio Nastor", "Marlon Flores", "Charelyn Mullaneda", "Jeffrey Gaden", "Joemar Venus", 
...
async function validateRSVP() {
    ...
    if (!isInvited) {
        if(errorDisplay) {
            ...
            // We scroll slightly so the message appeared under the button is visible
    ...
    // If invited, proceed with submission
    ...
    try {
        ...
        // Show the centralized thank you message
